...
/**
 * This program opens a Mosaic window that has a default color of black.
 ...
 * until, after about 25 visits, it has reached the maximum possible level.
...
public class BrightenUp {
	...
	final static int ROWS = 100;        
	   ...
	   final static int SQUARE_SIZE = 1;  
	   
	   static int currentRow, currentColumn; //rows and columns where the disturbance is.
	    ...
	    *                 been increased by 10, except that it does not go
	   ...
	   static void brightenSquare(int row, int col) {
	      ...
	      if (g > 255 || r > 255 || b > 255)
	          g = 255;
	      	  r = 255;		 
	      	  b = 255;
	      Mosaic.setColor(row,col,r,0,0); //try to manipulate the r, g, b parameters here!
	   }
